              ...
              >
                <DropdownMenuGroup>
                  ...
                  >
                    ...
                    <span className="text-xs ml-1">Ajustes</span>
                  </DropdownMenuItem>
              ...
              >
                <DropdownMenuGroup>
                  ...
                  >
                    ...
                    <span className="text-xs ml-1">Finanzas</span>
                  </DropdownMenuItem>
                  <hr className="my-1" />
                  <DropdownMenuItem
                    className={
                  ...
                  >
                    ...
                    <span className="text-xs ml-1">Tareas</span>
                  </DropdownMenuItem>
                  <hr className="my-1" />
                  <DropdownMenuItem
                    className={
                  ...
                  >
                    ...
                    <span className="text-xs ml-1">Graficos</span>
                  </DropdownMenuItem>
                  <hr className="my-1" />
                  <DropdownMenuItem
                    className={
