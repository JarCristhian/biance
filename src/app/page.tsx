        ...
        <main className="items-center p-2 pt-14 md:px-16 w-full max-w-2xl mx-auto">
          ...
          <div className="flex justify-between items-center mb-10 mt-3 md:px-20 px-4 select-none">
            <div className="flex gap-3 justify-start sm:justify-center cursor-pointer">
              <div className={`text-xl font-semibold ${menu === 0 ? "text-primary" : "text-zinc-300 dark:text-zinc-600"}`} onClick={() => setMenu(0)}>Efectivo</div>
              <div className={`text-xl font-semibold ${menu === 1 ? "text-primary" : "text-zinc-300 dark:text-zinc-600"}`} onClick={() => setMenu(1)}>
                Ahorros
              </div>
            </div>
